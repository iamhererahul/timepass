...
$sql = "SELECT u.username, u.email, gi.phone_number, gi.last_name, gi.first_name, gi.age, gi.gender, 
        ...
        JOIN organiser_event_registration e ON ea.event_id = e.event_id
  ...
  <body>
    <div class="page-content">
      <div class="sidebar">
        ...
        <li><a href="./pages/Applicants.php" class="sidebar-link"><i class="fa-solid fa-credit-card fa-fw"></i><span>Applicants</span></a></li>
